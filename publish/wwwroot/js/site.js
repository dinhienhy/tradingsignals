...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadActiveSignals() {
        // Show loading state
        activeSignalsList.innerHTML = '<tr><td colspan="5" class="text-center">Loading active signals...</td></tr>';
        ...
        .catch(error => {
            ...
            if (error.message.includes('401')) {
                ...
                activeSignalsList.innerHTML = '<tr><td colspan="5" class="text-center text-danger">Failed to load active signals. Check console for details.</td></tr>';
            }
        });
    }
    ...
    function renderActiveSignals(signals) {
        ...
        if (!signals || signals.length === 0) {
            activeSignalsList.innerHTML = '<tr><td colspan="5" class="text-center">No active signals found</td></tr>';
            return;
        }
